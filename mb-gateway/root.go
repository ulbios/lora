...
var (
	...
	rootCmd = &cobra.Command{
		Use:   "mb-gateway",
		Short: "A ModBus Gateway capable of receiving and sending data over LoRa.",
		Long: "This ModBus Gateway is capable of receiving data over LoRa and then relaying\n" +
			"it over LoRa to a central server. Its main purpose is extending the LoRa range\n" +
			"of an on-field deployment.",
